...
cartRouter.post("/cart-items", (req, res) =>{
  pool.query("INSERT INTO ShoppingCart(product, price, quantity) VALUES($1::text, $2::smallint, $3::smallint)",
...
cartRouter.put("/cart-items/:id", (req, res) =>{
  pool.query("UPDATE ShoppingCart SET product=$1::text, price=$2::smallint, quantity=$3::smallint WHERE id=$4::int",
